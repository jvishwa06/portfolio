...
import { VishwaMark } from "@/components/vishwa-mark";
import { AppleHelloVietnameseEffect } from "@/registry/apple-hello-effect";

const layers = ["xin-chao", "vishwa-wordmark"] as const;
    ...
    <>
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          ...
          {layers[currentIndex] === "vishwa-wordmark" && (
            <motion.div
            ...
            >
              <VishwaMark className="h-12 sm:h-16" />
            </motion.div>
          )}
        </div>
      </AnimatePresence>
